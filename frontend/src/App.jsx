      ...
      <main className="App">
        <div className="flex h-screen">
          ...
          <Sidebar>
            ...
            <SidebarItem icon={<UserCircle size={20} />} text="Inventory Management" path="/inventory-management" />
            <SidebarItem icon={<Boxes size={20} />} text="Check-In/Check-Out" path="/check" />
            <SidebarItem icon={<BarChart3 size={20} />} text="Reports" path="/reports" />
            <SidebarItem icon={<Package size={20} />} text="User Management" path="/user-management" />
            <hr className="my-3" />
