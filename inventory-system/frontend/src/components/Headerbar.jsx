  ...
  const getPageTitle = () => {
    switch (location.pathname) {
      case "/dashboard":
        return (
          <>
            <LayoutDashboard className="inline mr-2 text-red-400 w-auto h-8 bg-red-200 p-2 rounded-lg" />
            Dashboard
          </>
        );
      case "/inventory-management":
        return (
          <>
            <UserCircle2 className="inline mr-2 text-red-400 w-auto h-8 bg-red-200 p-2 rounded-lg" />
      ...
      case "/check":
        return (
          <>
            <Boxes className="inline mr-2 text-red-400 w-auto h-8 bg-red-200 p-2 rounded-lg" />
            Check-In/Check-Out
          </>
        );
      case "/reports":
        return (
          <>
            <BarChart3 className="inline mr-2 text-red-400 w-auto h-8 bg-red-200 p-2 rounded-lg" />
            Reports
          </>
        );
      case "/user-management":
        return (
          <>
            <Package className="inline mr-2 text-red-400 w-auto h-8 bg-red-200 p-2 rounded-lg" />
            User Management
          </>
        );
      case "/settings":
        return (
          <>
            <Settings className="inline mr-2 text-red-400 w-auto h-8 bg-red-200 p-2 rounded-lg" />
            Settings
          </>
        );
      case "/help":
        return (
          <>
            <LifeBuoy className="inline mr-2 text-red-400 w-auto h-8 bg-red-200 p-2 rounded-lg" />
            Help
          </>
        );
      default:
